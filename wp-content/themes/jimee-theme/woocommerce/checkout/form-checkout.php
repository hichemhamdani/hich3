...
<div class="jimee-checkout-auth">
    ...
    <div class="jimee-auth-panel" id="jimee-register-panel" style="display:none">
        <div class="jimee-register-fields">
            <div class="jimee-login-field">
                <label for="jimee-reg-pass">Mot de passe</label>
                <input type="password" id="jimee-reg-pass" name="account_password" autocomplete="new-password" placeholder="Choisissez un mot de passe">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="jimee-checkout-right">
            <div class="jimee-checkout-review">
                ...
                <div class="jimee-review-content">
                    ...
                    <!-- Totals (updated via WC fragment) -->
                    <div id="jimee-recap-totals">
                        <?php echo jimee_recap_totals_html(); ?>
                    </div>
