<?php
/**
 * ZR Express 2.0 API Request Handler.
 *
 * This class manages HTTP requests to the ZR Express 2.0 API,
...
/**
 * ZR Express 2.0 API request handler class.
 *
 * Handles all HTTP communication with the ZR Express 2.0 API,
 * including authentication, GET/POST requests, and response processing.
 */
class ZRExpressTwoRequest
{
    ...
    public function post($url, $data, string $method = self::POST)
    {
        ...
        // Set the authentication headers with API Key and Tenant ID
    ...
    /**
     * Get the authentication headers with API Key and Tenant ID.
     *
