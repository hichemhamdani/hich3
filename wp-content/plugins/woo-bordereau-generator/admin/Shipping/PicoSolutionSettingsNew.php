...
class PicoSolutionSettingsNew
{
    ...
    public function bulk_track($codes)
    {
        ...
        $response = $this->request->post($this->provider['api_url'] . 'FR/Exporter.awp', [
            'WD_ACTION_' => 'AJAXEXECUTE',
        ...
        $this->request->downloadFile($this->provider['api_url'] . 'FR/Excel.awp?P1=' . $filePath, $tmpFile);
