...
class PicoSolutionNew extends BordereauProvider implements BordereauProviderInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(WC_Order $formData, array $provider, $data = [])
    {
        ...
        $this->request = new PicoSolutionNewRequest($provider);
    }
    ...
    public function track($tracking_number, $post_id = null)
    {
        ...
        $response = $this->request->post($this->provider['api_url'].'FR/Liste.awp', [
            'WD_ACTION_' => 'AJAXEXECUTE',
    ...
    public function detail($tracking_number, $post_id)
    {
        ...
        $response = $this->request->request($this->provider['api_url'].'FR/ColisClient.awp?P1='.$tracking_number, [], PicoSolutionNewRequest::GET);
    ...
    private function get_wilayas()
    {
        ...
        $response = $this->request->request($this->provider['api_url'].'FR/Colis.awp', [], PicoSolutionNewRequest::GET);
