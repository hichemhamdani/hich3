...
class MaystroDeliveryLocalPickup extends DefaultLocalPickup
{

    public function __construct($instance_id = 0)
    {

        $this->id = 'local_pickup_maystro';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Maystro Delivery Local Pickup', 'woo-bordereau-generator');
        $this->method_description = __('Maystro Delivery Local Pickup Shipping method', 'woo-bordereau-generator');
    ...
    function init()
    {
        ...
        $this->provider = $this->get_option('provider', 'maystro_delivery');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title' => array(
                ...
                'default' => __('Maystro Delivery Local Pickup', 'woo-bordereau-generator'),
                'desc_tip' => true,
            ),
            'cost' => array(
