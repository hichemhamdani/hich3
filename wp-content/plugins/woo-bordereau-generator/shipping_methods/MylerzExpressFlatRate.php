...
class MylerzExpressFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_mylerz';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Mylerz Express Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Mylerz Express Flat Rate Shipping method', 'woo-bordereau-generator');
