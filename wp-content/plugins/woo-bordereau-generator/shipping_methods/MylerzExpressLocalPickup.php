...
class MylerzExpressLocalPickup extends DefaultLocalPickup
{

    public function __construct($instance_id = 0)
    {

        $this->id = 'local_pickup_mylerz';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Mylerz Express  Local Pickup', 'woo-bordereau-generator');
        $this->method_description = __('Mylerz Express Local Pickup Shipping method', 'woo-bordereau-generator');
    ...
    function init()
    {
        ...
        $this->provider = $this->get_option('provider', 'mylerz');
