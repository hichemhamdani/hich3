...
class EcotrackFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_ecotrack';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Ecotrack Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Flat Rate for Ecotrack Shipping method', 'woo-bordereau-generator');
