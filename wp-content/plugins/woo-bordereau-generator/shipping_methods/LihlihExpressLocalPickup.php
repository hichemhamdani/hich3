...
class LihlihExpressLocalPickup extends DefaultLocalPickup
{

    public function __construct($instance_id = 0)
    {

        $this->id = 'local_pickup_lihlihexpress';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Lihlih Express Local Pickup', 'woo-bordereau-generator');
        $this->method_description = __('Lihlih Express Local Pickup Shipping method', 'woo-bordereau-generator');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title' => array(
                ...
                'default' => __('Lihlih Express Local Pickup', 'woo-bordereau-generator'),
                'desc_tip' => true,
            ),
            'cost' => array(
