...
class ColivraisonFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_colivraison';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Colivraison Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Colivraison Flat Rate Shipping method', 'woo-bordereau-generator');
    ...
    function init()
    {
        ...
        $this->provider = $this->get_option('provider', 'colivraison');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title' => array(
                ...
                'default' => __('Colivraison Flat Rate', 'woo-bordereau-generator'),
                'desc_tip' => true,
            ),
            'cost' => array(
