...
class ElogistiaFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_elogistia';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Elogistia Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Elogistia Flat Rate Shipping method', 'woo-bordereau-generator');
