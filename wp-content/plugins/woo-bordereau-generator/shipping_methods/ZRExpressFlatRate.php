...
class ZRExpressFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0) {

        $this->id = 'flat_rate_zr_express';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('ZR Express Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('ZR Express Flat Rate Shipping method', 'woo-bordereau-generator');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title'      => array(
                ...
                'default'     => __( 'ZR Express Flat Rate', 'woo-bordereau-generator' ),
                'desc_tip'    => true,
            ),
            'cost'       => array(
