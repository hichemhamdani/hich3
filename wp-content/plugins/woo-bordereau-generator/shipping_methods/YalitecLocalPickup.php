...
class YalitecLocalPickup extends DefaultLocalPickup
{
	const ID = 'local_pickup_yalitec_new';

    public function __construct($instance_id = 0)
    {
        $this->id = 'local_pickup_yalitec_new';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Yalitec Local Pickup', 'woo-bordereau-generator');
        $this->method_description = __('Yalitec Local Pickup Shipping method', 'woo-bordereau-generator');
    ...
    function init()
    {
        ...
        $this->provider = $this->get_option('provider', 'yalitec_new');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title' => array(
                ...
                'default' => __('Yalitec Local Pickup', 'woo-bordereau-generator'),
                'desc_tip' => true,
            ),
            'cost' => array(
