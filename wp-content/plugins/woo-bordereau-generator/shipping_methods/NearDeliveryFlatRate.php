...
class NearDeliveryFlatRate extends DefaultFlatRate
{

    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_near_delivery';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Near Delivery Home Delivery', 'woo-bordereau-generator');
        $this->method_description = __('Near Delivery Home Delivery Shipping method', 'woo-bordereau-generator');
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title' => array(
                ...
                'default' => __('Near Delivery Home Delivery', 'woo-bordereau-generator'),
                'desc_tip' => true,
            ),
            'cost' => array(
