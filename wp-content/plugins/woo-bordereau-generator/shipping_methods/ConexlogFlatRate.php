...
class ConexlogFlatRate extends DefaultFlatRate
{
    public function __construct($instance_id = 0)
    {

        $this->id = 'flat_rate_conexlog';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Conexlog Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Conexlog Flat Rate Shipping method', 'woo-bordereau-generator');
