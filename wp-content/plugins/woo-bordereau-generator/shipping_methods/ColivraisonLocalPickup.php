...
class ColivraisonLocalPickup extends DefaultLocalPickup
{
    protected $address;
    protected $map;
    protected $center_id;
    ...
    public function __construct($instance_id = 0)
    {
        ...
        $this->id = 'local_pickup_colivraison';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Colivraison Local Pickup', 'woo-bordereau-generator');
        $this->method_description = __('Colivraison Local Pickup Shipping method', 'woo-bordereau-generator');
