...
class YalitecFlatRate extends DefaultFlatRate
{
	const ID = 'flat_rate_yalitec_new';

	public function __construct($instance_id = 0) {

        $this->id = 'flat_rate_yalitec_new';
        $this->instance_id = absint($instance_id);
        $this->method_title = __('Yalitec Flat Rate', 'woo-bordereau-generator');
        $this->method_description = __('Yalitec Flat Rate Shipping method', 'woo-bordereau-generator');
    ...
    function init() {
        ...
        $this->provider             = $this->get_option( 'provider', 'yalitect_new' );
    ...
    public function init_form_fields()
    {
        $this->instance_form_fields = array(
            'title'      => array(
                ...
                'default'     => __( 'Yalitec Flat Rate', 'woo-bordereau-generator' ),
                'desc_tip'    => true,
            ),
            'cost'       => array(
